...
title: "Team"
sidebarTitle: "Team"
description: "Invite and remove developers, manage pending invitations, and understand the single-permission access model of an Healine deployment from Settings → Team in the developer portal."
keywords: ["invite team member", "developer accounts", "developer roles", "admin account", "access model", "invitation link"]
"og:title": "Team | Healine"
"og:description": "Invite and remove developers, manage pending invitations, and understand the single-permission access model of an Healine deployment from Settings → Team in the developer portal."
"og:type": "article"
"twitter:title": "Team | Healine"
"twitter:description": "Invite and remove developers, manage pending invitations, and understand the single-permission access model of an Healine deployment from Settings → Team in the developer portal."
...
Click **Invite Member** and enter an email address. Healine creates the invitation and queues an email with a link to create the account.
...
Healine has a single permission level for developer accounts.
