...
description: "Decide which data provider and which device type wins when data overlaps in time, from Settings → Priorities in the Healine developer portal."
keywords: ["provider priority", "device type priority", "overlapping data", "multiple wearables", "data source precedence"]
"og:title": "Priorities | Healine"
"og:description": "Decide which data provider and which device type wins when data overlaps in time, from Settings → Priorities in the Healine developer portal."
"og:type": "article"
"twitter:title": "Priorities | Healine"
"twitter:description": "Decide which data provider and which device type wins when data overlaps in time, from Settings → Priorities in the Healine developer portal."
