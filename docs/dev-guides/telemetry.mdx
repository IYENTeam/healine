...
sending code lives in `backend/app/services/telemetry_service.py` and is easy to audit.
...
This fully disables telemetry: no scheduled task, no startup ping, no HTTP calls.
