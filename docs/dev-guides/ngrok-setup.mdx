...
description: "Use ngrok to expose your local Healine backend for Garmin OAuth callbacks, webhook testing, and Apple Health SDK integration. Quick setup."
keywords: ["ngrok healine", "expose local backend webhooks", "garmin oauth ngrok", "local health api testing"]
"og:title": "Expose Local Backend with ngrok | Healine"
...
"og:type": "article"
"twitter:title": "Expose Local Backend with ngrok | Healine"
...
<Steps>
  ...
  <Step title="Start your backend">
    Ensure your Healine backend is running locally (typically on port 8000):
