...
description: "Add a new fitness data provider to Healine. Covers Strategy, Factory, and Template Method patterns for OAuth, workout, and webhook handlers."
keywords: ["add wearable provider", "healine contribution", "provider integration guide", "wearable api provider"]
"og:title": "Add a Wearable Provider Integration | Healine"
"og:description": "Add a new provider to Healine. Covers Strategy, Factory, OAuth, workout, 24/7, and webhook handler patterns."
"og:type": "article"
"twitter:title": "Add a Wearable Provider Integration | Healine"
"twitter:description": "Add a new provider to Healine. Covers Strategy, Factory, OAuth, workout, 24/7, and webhook handler patterns."
"twitter:card": "summary_large_image"
---

# How to Add a New Provider Integration

This guide walks you through the process of adding a new fitness data provider (e.g. Strava, Samsung Health, Xiaomi, WHOOP) to the Healine platform. The architecture uses design patterns like **Strategy**, **Factory**, and **Template Method** to make adding new providers straightforward and consistent.
...
<Steps>  
  <Step title="_normalize_workout()">
    **Most important!** Convert provider's data format to Healine [unified schema](/architecture/unified-data-model).
  </Step>
...
```python
"""Suunto activity type to Healine unified workout type mapping."""
...
<Check>
Congratulations! You've successfully integrated a new provider into Healine. 🎉
</Check>
