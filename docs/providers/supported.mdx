...
keywords: ["wearable device integrations", "supported wearables api", "wearable api providers", "healine"]
"og:title": "Supported Wearable Device Integrations | Healine"
...
"og:type": "article"
"twitter:title": "Supported Wearable Device Integrations | Healine"
...
Connect your wearable devices and fitness platforms to Healine. Click on a provider name to view its setup guide.
...
More providers are being added regularly. Track upstream provider requests and implementations on [Open Wearables issues](https://github.com/the-momentum/open-wearables/issues?q=is%3Aissue+label%3Aprovider-request) tagged with `provider-request`.
...
3. **Configure credentials** in your Healine instance
