...
"og:title": "Ultrahuman Ring API Integration | Healine"
...
"og:type": "article"
"twitter:title": "Ultrahuman Ring API Integration | Healine"
...
<Note>
**Need help with your Ultrahuman integration?** Pop into our [Discord](https://discord.gg/qrcfFnNE6H) if you have questions or want to discover how Healine can solve your problems.
</Note>
...
| Method | Description |
|--------|-------------|
| **Polling (pull)** | Healine periodically fetches daily metrics via the Ultrahuman Partnership API (default: every hour via Celery Beat) |
...
```
  ...
  <Step title="Connect a user via OAuth">
    ...
    **3. Ultrahuman redirects back** to the callback URI configured in your `.env`. Healine automatically exchanges the authorization code for access and refresh tokens.
