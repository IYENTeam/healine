...
keywords: ["wearable provider setup", "garmin sync configuration", "health api provider config", "healine provider params"]
"og:title": "Wearable Provider Setup and Sync Guide | Healine"
...
"og:type": "article"
"twitter:title": "Wearable Provider Setup and Sync Guide | Healine"
...
<Note>
  Apple Health requires the Healine mobile SDK. Cloud sync is not available for Apple Health.
</Note>
