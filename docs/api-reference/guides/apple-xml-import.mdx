...
"og:title": "Import Apple Health XML Export | Healine"
...
"og:type": "article"
"twitter:title": "Import Apple Health XML Export | Healine"
...
#!/usr/bin/env python3
"""Upload an Apple Health export with the Healine multipart API."""
...
<Tabs>
  <Tab title="S3 Presigned POST (SNS mode)">
    ...
    #!/usr/bin/env python3
    """
    Upload Apple Health XML export to Healine using S3.
  ...
  <Tab title="Direct Upload">
    ...
    #!/usr/bin/env python3
    """
    Upload Apple Health XML export directly to Healine API.
